...
static size_t draw_ui_unsafe()
{
    ...
    c1 += draw_col1(col1+c1, sizeof(g_term_buffer) - c1, "", "", "",                                214, " ", du_info.Tmax,    du_info.peak_min_buf,   du_info.peak_max_buf,   " ", NULL);
    c1 += draw_col1(col1+c1, sizeof(g_term_buffer) - c1, "", "", "",                                220, " ", du_info.Tmid,    du_info.peak_min_buf,   du_info.peak_max_buf,   "", draw_extra_check);
